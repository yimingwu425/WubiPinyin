target("WeaselSetup")
  set_kind("binary")
  set_filename("WubiPinyinSetup.exe")
  add_files("./*.cpp")
  ...
  after_build(function(target)
      os.cp(path.join(target:targetdir(), "WubiPinyinSetup.exe"), "$(projectdir)/output")
      os.cp(path.join(target:targetdir(), "WubiPinyinSetup.pdb"), "$(projectdir)/output")
  end)
